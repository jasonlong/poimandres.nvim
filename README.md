...
poimandres](https://github.com/enkia/tokyo-night-vscode-theme) theme. Includes
...
- Provides [poimandres](https://github.com/folke/poimandres.nvim)
...
colorscheme poimandres-night
colorscheme poimandres-storm
colorscheme poimandres-day
colorscheme poimandres-moon
```
...
```vim
" Vim Script
let g:lightline = {'colorscheme': 'poimandres'}
```

## ⚙️ Configuration

> ❗️ Set the configuration **BEFORE** loading the color scheme with `colorscheme poimandres`.
...
[poimandres](https://github.com/folke/poimandres.nvim) uses the default options,
...
[storm](extras/lua/poimandres_storm.lua),
[moon](extras/lua/poimandres_moon.lua),
[night](extras/lua/poimandres_night.lua), and
[day](extras/lua/poimandres_day.lua) themes.
...
```lua
local colors = require("poimandres.colors").setup() -- pass in any of the config options as explained above
...
1. Create a file like `lua/poimandres/extra/cool-app.lua`.
2. Add the name and output file extension to the `extras` table in
   `lua/poimandres/extra/init.lua`.
3. Run the following command to generate new [extra](#-extras) themes from the poimandres plugin directory:

   ```sh
   nvim --headless "+lua require('poimandres.extra').setup()" +qa
   ```
